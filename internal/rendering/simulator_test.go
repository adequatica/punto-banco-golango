	...
	tests := []struct {
	...
	}{
		{
			...
			stats: &simulator.MultipleSimulationsStats{
				...
				GamesWithZeroWins:         1,
				ZeroWinsRate:              1.0,
				AvgMaxConsecutiveWins:     3.2,
				MaxConsecutiveWins:        4,
				AvgMaxConsecutiveLosses:   2.1,
				MaxConsecutiveLosses:      1,
				AvgMaxBudgetReached:       1010.0,
				MaxBudgetReacorded:        1100.0,
				GamesWithProfitableBudget: 1,
				ProfitableBudgetRate:      1.0,
			},
			wantContains: []string{
				"Statistics category",
			},
